...
#define CU_ENUMS_DESCRIPTION \
    CU_BEGIN_ENUM(ErrorCode) \
        ...
        CU_ENUM_UNIT(E_DX12_CREATE_SRV_HEAP_FAILED) \
        ...
        CU_ENUM_UNIT(E_RM_ANIMATION_LOAD_FAILED) \
...
#undef CU_ENUMS_DESCRIPTION
    ...
    static inline std::string describe_error(ErrorCode code) {
        ...
        case ErrorCode::E_DX12_CREATE_CBV_HEAP_FAILED:
            ...
            break;
        case ErrorCode::E_DX12_CREATE_SRV_HEAP_FAILED:
            result << "DX12 - SRV CreateDescriptorHeap Failed";
            break;
        ...
        case ErrorCode::E_ENG_SHADER_BYTECODE_NOT_FOUND:
            ...
            break;
        case ErrorCode::E_ENG_SHADER_NOT_FOUND:
        ...
        case ErrorCode::E_RM_SHADER_ALREADY_EXISTS:
            result << "Resource Manager - Shader with such name and type already exists";
            break;
        ...
        case ErrorCode::E_RM_ANIMATION_NOT_FOUND:
            ...
            break;
        case ErrorCode::E_RM_ANIMATION_LOAD_FAILED:
            result << "Resource Manager - Animation load failed";
            break;
